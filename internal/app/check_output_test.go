...
func sampleCheckReport(t *testing.T) *CheckReport {
	...
	return &CheckReport{
		...
		Entries: []CheckEntry{
			...
			{ID: checkHeaders, Group: "handshake", Status: CheckPass,
				Detail: "Upgrade/Connection tokens present"},
			{ID: checkSubprotoNone, Group: "negotiation", Status: CheckFail,
				Detail: `server selected "chat" with none offered`},
